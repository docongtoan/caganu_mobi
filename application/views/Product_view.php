...
<html lang="en">
  <head>
    ...
    <link rel="shortcut icon" href="../../public/img/logo-favicon-32x32.png">
    <!-- Twitter -->
    ...
    <!-- Katniss CSS -->
    <link rel="stylesheet" href="../../public/css/katniss.css">
  ...
  <body class="hide-left">
    ...
    <div class="kt-headpanel">
      <div class="kt-headpanel-left image-logo-caganu">
        ...
        <div class="">
          <a href="index.html"><img class="logo-caganu" src="../../public/img/logo-caganu-non.png"></a>
        </div>
    ...
    <p></p>
      ...
      <div class="row">
        <div class="col-xs-6 col-sm-3 product">
            ...
            <a href="product_detail.html"><img class="image-product" src="../../public/img/cancau.jpg"></a>
    ...
    <hr style="width:100%;">
       <div class="col-xs-12 col-sm-12">
        ...
        <img src="../../public/img/logo-caganu-non.png" style="display: block; margin-left: auto; margin-right: auto;">
    ...
    <script src="../../public/lib/gmaps/gmaps.js"></script>
    <script src="../../public/lib/chart.js/Chart.js"></script>

    <script src="../../public/js/katniss.js"></script>
